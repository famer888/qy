...
class MoreAndMoreNormal extends BaseWidget {
  MoreAndMoreNormal({Key key, this.id}) : super(key: key);
  String id = "0";

  @override
  State<StatefulWidget> cState() {
    // TODO: implement cState
    return _MoreAndMoreNormalState();
  }
}

class _MoreAndMoreNormalState extends BaseWidgetState<MoreAndMoreNormal> {
        ...
        Expanded(
          child: PageView(
            ...
            children: [
              ...
              PageViewMixin(
                  child: MoreAndMoreNormalChild(type: "new", id: widget.id)),
            ],
          ),
        )
      ],
...
class MoreAndMoreNormalChild extends StatefulWidget {
  MoreAndMoreNormalChild({Key key, this.type, this.id, this.titleFunc})
      : super(key: key);
  final String type;
  final String id;
  ...
  @override
  State<MoreAndMoreNormalChild> createState() => _MoreAndMoreNormalChildState();
}

class _MoreAndMoreNormalChildState extends State<MoreAndMoreNormalChild> {
  int page = 1;
  bool isHud = true;
  List<dynamic> values = [];
  dynamic value;
