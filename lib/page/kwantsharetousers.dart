                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: userInviteNumber == null
                                                                                    ? Container()
                                                                                    : Center(
                                                                                        child: RichText(
                                                                                            text: TextSpan(children: [
                                                                                          TextSpan(text: CommonUtils.txt('ljyq') + ' ', style: GQStyle.white9255_15),
                                                                                          TextSpan(text: '$userInviteNumber' + CommonUtils.txt('ren'), style: GQStyle.jellyCyan_15)
                                                                                        ])),
                                                                                      ),
                                                                              ),
                                                                            ],
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: QrImage(
                                                                                ...
                                                                                version: 3,
                                                                                size: ScreenUtil().setWidth(134),
                                                                              ),
                                                                            ),
                                                                            RichText(
                                                                              text: TextSpan(text: CommonUtils.txt('wdggm'), style: GQStyle.white9255_15, children: <TextSpan>[
                                                                                TextSpan(text: '${member.share.affCode}', style: GQStyle.jellyCyan_25_semi)
                                                                              ]),
                                                                            ),
                                                                          ],
                                                                        ),
                                                              ...
                                                              return RichText(
                                                                  text: TextSpan(
                                                                      children: list
                                                                          .map((e) => TextSpan(
                                                                              text: e['word'],
                                                                              style: e['type'] == 1 ? highlightStyle : GQStyle.white255_13))
                                                                          .toList()));
                                                            }),
                                                          ],
                                                        ),
