...
class CommunityCircleNew extends StatefulWidget {
  CommunityCircleNew({Key key, this.id = 0, this.sort = "new", this.call})
      : super(key: key);
  final int id;
  final String sort;
  ...
  @override
  State<CommunityCircleNew> createState() => _CommunityCircleNewState();
}

class _CommunityCircleNewState extends State<CommunityCircleNew> {
  int page = 1;
  bool noMore = false;
  ...
  _getData() {
    circleSortList(id: widget.id, sort: widget.sort, page: page).then((res) {
      if (res.data == null) {
        networkErr = true;
        setState(() {});
        return;
