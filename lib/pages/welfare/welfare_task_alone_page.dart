...
class WelfareTaskAlonePage extends BaseWidget {
  WelfareTaskAlonePage({Key key}) : super(key: key);

  @override
  _WelfareTaskAlonePageState cState() => _WelfareTaskAlonePageState();
}

class _WelfareTaskAlonePageState extends BaseWidgetState<WelfareTaskAlonePage> {
  Config config;
  Member member;
  ...
  void onCreate() {
    ...
    setAppTitle(title: CommonUtils.txt("flrw"));
    _loadTaskData();
  }
