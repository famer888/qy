...
///最新界面
class ComicNewScreen extends StatefulWidget {
  const ComicNewScreen({super.key});

  @override
  State<ComicNewScreen> createState() => _ComicNewScreenState();
}

class _ComicNewScreenState extends State<ComicNewScreen> {
