...
///完结界面
class ComicEndScreen extends StatefulWidget {
  const ComicEndScreen({super.key});

  @override
  State<ComicEndScreen> createState() => _ComicEndScreenState();
}

class _ComicEndScreenState extends State<ComicEndScreen> {
