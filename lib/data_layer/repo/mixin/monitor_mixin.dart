...
mixin _Monitor on _BaseAppRepo implements MonitorDomain {
  ...
  AsyncResult<MonitorWithBannersModel> getMonitorIndex({
    ...
    required int limit,
      ...
      _monitorService
          .getMonitorIndex(id: id, page: page, limit: limit)
          .deserializeJsonBy(MonitorWithBannersModel.fromJson)
          .guard;
  ...
  AsyncResult<List<MonitorModel>?> getMonitorSearch({
    ...
    required int limit,
      ...
      _monitorService
          ...
          .deserializeJsonListBy((e) => e.map(MonitorModel.fromJson).toList())
          .guard;

  @override
  AsyncResult<MonitorVideoDetailData?> getMonitorDetail({required int id}) =>
      _monitorService
          .getMonitorDetail(id: id)
          .deserializeJsonBy(MonitorVideoDetailData.fromJson)
          .guard;
