...
//横屏横向滚动 type = 11
class LandscapeScrolling extends StatefulWidget {
  LandscapeScrolling({Key key, this.data}) : super(key: key);
  dynamic data;

  @override
  State<LandscapeScrolling> createState() => _LandscapeScrollingState();
}

class _LandscapeScrollingState extends State<LandscapeScrolling> {
                              ...
                              SizedBox(
                                ...
                                child: PlatformAwareNetworkImage(
                                    url: clipImageUrl(CommonUtils.getThumb(e),
                                        inputWidth: ScreenUtil().setWidth(250)),
                                    borderRadius:
