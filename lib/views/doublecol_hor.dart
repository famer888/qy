...
//双列横屏 type = 4
class DoubleColHor extends StatefulWidget {
  DoubleColHor({Key key, this.data}) : super(key: key);
  dynamic data;

  @override
  State<DoubleColHor> createState() => _DoubleColHorState();
}

class _DoubleColHorState extends State<DoubleColHor> {
                ...
                widget.data["more_button"] == 0
                    ...
                    : GestureDetector(
                        ...
                        onTap: () {
                          ...
                          } else if (widget.data["more_page_show_type"] == 4) {
                            context.push(
                                '/more_and_more_carton/${widget.data["id"] ?? "0"}');
                          } else {
                            context.push(
