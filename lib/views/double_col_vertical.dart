...
//双列竖屏 type=14
class DoubleColVertical extends StatefulWidget {
  DoubleColVertical({Key key, this.data}) : super(key: key);
  dynamic data;

  @override
  State<DoubleColVertical> createState() => _DoubleColVerticalState();
}

class _DoubleColVerticalState extends State<DoubleColVertical> {
    ...
    return Column(
      children: [
        ...
        GridView.count(
          ...
          childAspectRatio:
              170 / (widget.data["content_type"] == 6 ? 256 : 255 + 15),
                            ...
                            SizedBox(
                              ...
                              child: PlatformAwareNetworkImage(
                                  url: clipImageUrl(CommonUtils.getThumb(e),
                                      inputWidth: ScreenUtil().setWidth(170)),
                                  borderRadius:
