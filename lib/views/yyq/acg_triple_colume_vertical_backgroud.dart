...
/// 动漫-三列竖屏+背景 type = 7
class AcgTripleColumeVerticalBackgroud extends StatelessWidget {
  AcgTripleColumeVerticalBackgroud({Key key, this.data}) : super(key: key);
  dynamic data;
        ...
        Container(
          ...
          decoration: BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: [Color(0xff125d67), Color(0xff324f5b)]),
