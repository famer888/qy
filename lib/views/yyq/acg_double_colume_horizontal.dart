...
//双列横屏 type = 2
class AcgDoubleColumeHorizontal extends StatelessWidget {
  AcgDoubleColumeHorizontal({Key key, this.data}) : super(key: key);
  dynamic data;
    ...
    return Column(
      children: [
                ...
                child: SizedBox(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        data['more_button'] == null || data["more_button"] == 0
                            ? Container()
                            : GestureDetector(
        ...
        GridView.count(
          ...
          childAspectRatio:
              (data['content_type'] == 1 || data['content_type'] == 24)
                  ? 171 / 131.5
                  : 171 / 136,
